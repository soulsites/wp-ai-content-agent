...
// Built-in agent definitions for pipeline display (letter abbreviations, no emoji)
$agents = [
    [ 'abbr' => 'CA', 'label' => 'Content-Analyse' ],
    [ 'abbr' => 'ZA', 'label' => 'Zielgruppe'      ],
    [ 'abbr' => 'KW', 'label' => 'Keywords'         ],
    [ 'abbr' => 'TR', 'label' => 'Recherche'        ],
    [ 'abbr' => 'CW', 'label' => 'Schreiben'        ],
];
?>
<div class="wrap aica-wrap">
    <div class="aica-header">
        <h1>WP AI Content Agent</h1>
    ...
    <div class="notice notice-warning aica-notice">
        <p><strong>API-Schlüssel fehlt.</strong> Bitte konfiguriere deinen
                ...
                <div class="aica-pipeline">
                    <?php foreach ( $agents as $i => $a ) : ?>
                        ...
                        <div class="aica-pipeline-step">
                            <div class="aica-pipeline-icon"><?php echo esc_html( $a['abbr'] ); ?></div>
                            <div class="aica-pipeline-label"><?php echo esc_html( $a['label'] ); ?></div>
                        </div>
                    <?php endforeach; ?>
                </div>
            </div>
                ...
                <table class="aica-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                <?php if ( $item->wp_post_id ) : ?>
                                    <a href="<?php echo esc_url( get_edit_post_link( $item->wp_post_id ) ); ?>"
                                       style="margin-left:4px;font-size:11px;" target="_blank">Bearbeiten</a>
                                <?php endif; ?>
                            </td>
                            <td>
                            ...
                            <td><?php echo esc_html( wp_date( 'd.m.Y', strtotime( $item->created_at ) ) ); ?></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
